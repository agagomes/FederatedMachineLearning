...
def test_baseline_merge_amrules():
    ...
    merged_learner.samples_seen += copy.deepcopy(learners[0].samples_seen)
    merged_learner.sum_target += copy.deepcopy(learners[0].sum_target)
    merged_learner.sum_target_square += copy.deepcopy(learners[0].sum_target_square)
    merged_learner.sum_attribute = copy.deepcopy(learners[0].sum_attribute)
    merged_learner.sum_attribute_squares = copy.deepcopy(learners[0].sum_attribute_squares)
    merged_learner.rule_set += copy.deepcopy(learners[0].rule_set)
    ...
    base_line_pred = copy.deepcopy(base_line).predict(X)
...
test_no_rule_repetition_merge_amrules()
test_best_default_rule_merge_amrules()
test_best_default_no_rule_repetition_rule_merge_amrules()
